...
public class ActivityItemDetails extends AppCompatActivity {
    ...
    public static void navigate(AppCompatActivity activity, View transitionImage, Product obj) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // get extra object
        itemModel = (Product) getIntent().getParcelableExtra(EXTRA_OBJCT);
        initToolbar();
